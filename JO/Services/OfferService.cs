...
namespace JO.Services
{
        ...
        public async Task<BaseResponse> AddOffer(AddOfferForm form)
        {
            ...
            catch (Exception ex)
            {
                ...
                response.Message = "Error adding offer: " + ex.Message;
            }
        ...
        public async Task<BaseResponse> DeleteOffer(Offer offer)
        {
            ...
            {
                response.StatusCode = 500;
                response.Message = "Error removing offer";
                return response;
            }
        ...
        public async Task<BaseResponse> EditOffer(Offer offer)
        {
            ...
            {
                response.StatusCode = 400;
                response.Message = "Offer cannot be null.";
                return response;
            }
            ...
            try
            {
                using (var context = _factory.CreateDbContext())
                {
                    ...
                    existing.TicketCount = offer.TicketCount;
        ...
        public async Task<GetOffersResponse> GetOffers()
            {
                ...
                {
                    response.StatusCode = 500;
                    response.Message = "Error retrieving offers: " + ex.Message;
